...
const FormGeneration: FunctionComponent<Props> = ({
    ...
    const createCustomerTerm = useMutation({
        mutationFn: data =>
            Api.manufacture.insertManufactureQualityAssurance(data),
        onSuccess: () => {
            load();
            toast.success(
    ...
    const updateCustomerTerm = useMutation({
        mutationFn: data =>
            Api.manufacture.updateManufactureQualityAssurance(id, data),
        onSuccess: () => {
            load();
            toast.success(
                'Thank you! Your request has been successfully sent.',
    ...
    const handleNavigateToEdit = useCallback(
        (itemId: number) => {
            navigate(`/manufacture/template/quality_assurance/${itemId}`);
        },
        [navigate],
    );
