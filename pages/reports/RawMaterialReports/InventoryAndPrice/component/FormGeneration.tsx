...
const FormGeneration: FunctionComponent<Props> = ({
    ...
    const baseURL =
        ...
        `${ReportBaseUrl}/raw_material_inventory_and_price`;
        ...
        return overrideFields(fields, [
            {
                ...
                onClick: () => {
                    const url = buildUrlFromParams(baseURL, selectedKeys, {
                        ...(watchAllData?.raw_material && {
                            obj_id:
                                watchAllData?.raw_material?.id ||
                                watchAllData?.raw_material,
                        }),
                    });
                    if (url.length > 0) {
    ...
    }, [fields, watchAllData, handleGenerateReport]);
    ...
    console.log(handleGenerateReport.isLoading, '-- is loading   --');
    return (
        <Form
            display="flex"
